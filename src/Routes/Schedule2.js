...
function Schedule2() {
  ...
  return (
    <div className="date_main sd_1">
      <h1>Your interview session has been booked with LearnPrep! </h1>
        ...
        <div>
          ...
          <div className="flex flex-col justify-between h-[208px] shrink-0">
            ...
            <div className="mb-3">
              ...
              >
                <button className="sd_2 sd_3">Go To Preparation</button>
              </NavLink>
              <button className="sd_2" onClick={HandleCancle}>
                Cancle Interview
              </button>
            </div>
            <h3 className="sd_5">
        ...
        <div className="detailes box">
          <div className="p-4  ">
            ...
            <ul>
              ...
              <li className="contents">
                Choose an appropriate location: Find a quiet, well-lit space
                where you won't be interrupted during the interview. Ensure that
                the background is professional and free from distractions.
                <br />
              </li>
